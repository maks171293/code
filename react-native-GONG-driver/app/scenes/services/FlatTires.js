...
class FlatTires extends React.Component {
        ...
        setTimeout(() => {
            if (this.props.registrationProcess) {
                ...
                this.props.changeBackButton(
                    ...
                    {service: {id: 6}, registrationProcess: this.props.registrationProcess}
                );
            }
    ...
    _doRouteAfterSubmit() {
        if (this.props.registrationProcess) {
            Actions.backgroundCheck({service: {id: this.props.service.id}, registrationProcess: this.props.registrationProcess});
        } else {
            Actions.rates();
        }
    }
        ...
        return (
            ...
            >
                <TouchableWithoutFeedback onPress={()=> dismissKeyboard()}>
                    <View style={{flex: 1}}>
                        <View style={{flex: 1}}>
                            <Text style={LayoutStyle.h1}>{strings["Setup flat tires rates"]}</Text>
