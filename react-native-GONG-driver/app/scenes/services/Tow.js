...
class Tow extends React.Component {
        ...
        setTimeout(() => {
            if (this.props.registrationProcess) {
                ...
                this.props.changeBackButton(
                    ...
                    {service: {id: this.props.service.id - 1}, registrationProcess: this.props.registrationProcess, flag1: true}
                );
            }
    ...
    _doRouteAfterSubmit() {
        if (this.props.registrationProcess) {
            Actions.winchService({service: {id: this.props.service.id+1}, registrationProcess: this.props.registrationProcess});
        } else {
            Actions.rates();
        }
    }
        ...
        return (
            ...
            >
                <TouchableWithoutFeedback onPress={()=> dismissKeyboard()}>
                    <View style={{flex: 1}}>
                        <View style={{flex: 1}}>
                            <Text style={LayoutStyle.h1}>{strings["Setup tow rates"]}</Text>
