    ...
    render() {
        return (
            <View style={[LayoutStyle.container, LayoutStyle.containerFlex]}>
                <Text style={[LayoutStyle.fuelTitle]}>Terms of business</Text>
                <KeyboardAwareScrollView>
                    <View style={{
                        ...
                        <View style={{
                            ...
                            <Text style={LayoutStyle.fuelText}>Terms Of Service</Text>
                            <Text style={LayoutStyle.fuelText}>GONG Terms &amp; Conditions for End Users</Text>
                            <Text style={LayoutStyle.fuelText}>Last updated: November 8, 2016.</Text>
                        </View>
                        ...
                        <Text style={[LayoutStyle.aboutUsText]}>The Service is a communications platform for enabling
                            ...
                            PARTY SERVICES.</Text>
                        <Text style={[LayoutStyle.textTerms]}>Representations and Warranties</Text>
                        ...
                        <Text style={LayoutStyle.textTerms}>By using the Software or the Service, you agree that:</Text>

                        <Text style={LayoutStyle.textTerms}>• You will only use the Service or Software for lawful
                            purposes; you will not use the Service

                            for sending or storing any unlawful material or for fraudulent purposes.</Text>

                        <Text style={LayoutStyle.textTerms}>• You will not use the Service or Software to cause
                            nuisance, annoyance or inconvenience.</Text>

                        <Text style={LayoutStyle.textTerms}>• You will not impair the proper operation of the
                            network.</Text>

                        <Text style={LayoutStyle.textTerms}>• You will not try to harm the Service or Software in any
                            way whatsoever.</Text>

                        <Text style={LayoutStyle.textTerms}>• You will not copy, or distribute the Software or other
                            content without written permission

                            from the Company.</Text>

                        <Text style={LayoutStyle.textTerms}>• You will only use the Software and Service for your own
                            use and will not resell it to a third

                            party.</Text>

                        <Text style={LayoutStyle.textTerms}>• You will keep secure and confidential your account
                            password or any identification

                            provided to you which allows access to the Service.</Text>

                        <Text style={LayoutStyle.textTerms}>• You will provide us with whatever proof of identity the
                            Company may reasonably request.</Text>

                        <Text style={LayoutStyle.textTerms}>• You will only use an access point or data account which
                            you are authorized to use.</Text>

                        <Text style={LayoutStyle.textTerms}>• You will not portray Company or its affiliates in a
                            negative manner or otherwise portray its

                            services in a false, misleading, derogatory or offensive manner.</Text>

                        <Text style={LayoutStyle.textTerms}>• When requesting Third Party Services by SMS, you opt-in to
                        ...
                        <Text style={LayoutStyle.textTerms}>• You will not post or transmit any photograph or likeness
                            of another person without that

                            person&#39;s consent, if and to the extent necessary under applicable laws.</Text>

                        <Text style={LayoutStyle.textTerms}>• You will not post, publish, transmit, reproduce,
                        ...
                        <Text style={LayoutStyle.textTerms}>• You will not upload, post, publish, transmit, reproduce,
                        ...
                        <Text style={[LayoutStyle.textTerms]}>The Company hereby grants you a non-exclusive,
                        ...
                        <Text style={[LayoutStyle.textTerms]}>Company or the Third Party Service provider may charge
                        ...
                        <Text style={[LayoutStyle.textTerms]}>Any fees which the Company or Third Party Service Provider
                        ...
                        <Text style={[LayoutStyle.textTerms]}>Public Postings</Text>
                        ...
                        <Text style={[LayoutStyle.textTerms]}>Intellectual Property Ownership</Text>
                        ...
                        <Text style={[LayoutStyle.textTerms]}>During use of the Software and Service, you may enter into
                            correspondence with,
                        ...
                        <Text style={[LayoutStyle.textTerms]}>By entering into this Agreement and using the Software or
                        ...
                        <Text style={[LayoutStyle.textTerms]}>The Company reserves the right to (i) modify or
                        ...
                        <Text style={[LayoutStyle.textTerms]}>THE COMPANY MAKES NO REPRESENTATION, WARRANTY, OR GUARANTY
                            AS TO
                        ...
                        <Text style={[LayoutStyle.textTerms]}>THE COMPANY&#39;S SERVICE AND SOFTWARE MAY BE SUBJECT TO
                            LIMITATIONS,
                        ...
                        <Text style={[LayoutStyle.textTerms]}>IN NO EVENT SHALL THE COMPANY&#39;S AGGREGATE LIABILITY
                            EXCEED THE
                        ...
                        <Text style={[LayoutStyle.textTerms]}>Notice</Text>
                        <Text style={[LayoutStyle.textTerms]}>The Company may give notice to you by means of a general
                        ...
                        <Text style={[LayoutStyle.textTerms]}>The Service is controlled, operated and administered by us
                        ...
                        <Text style={[LayoutStyle.textTerms]}>You accept that, as a corporation, the Company has an
                        ...
                        <Text style={[LayoutStyle.textTerms]}>Without prejudice to the Company&#39;s other rights under
                        ...
                        <Text style={[LayoutStyle.textTerms]}>This Agreement may not be assigned by you without the
                        ...
                        <Text style={[LayoutStyle.textTerms]}>Except as expressly provided otherwise, this Agreement
                        ...
                        <Text style={[LayoutStyle.textTerms]}>No joint venture, partnership, employment, or agency
